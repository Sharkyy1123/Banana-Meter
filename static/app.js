const els = {
  ...
  sensorValue: document.querySelector('#sensorValue'), sensorTime: document.querySelector('#sensorTime'), sensorDot: document.querySelector('#sensorDot'), sparkline: document.querySelector('#sparkline'),
  ...
  resultLabel: document.querySelector('#resultLabel'), resultDetail: document.querySelector('#resultDetail'), resultConfidence: document.querySelector('#resultConfidence'), visualScore: document.querySelector('#visualScore'), usedSensor: document.querySelector('#usedSensor'), sensorIndex: document.querySelector('#sensorIndex'),
